<div class="container-fluid text-center">    
  <div class="row content" id="forms">
    <div class="col-sm-18 col-sm-offset-1 text-left">
		...
		<p class="lead">You will be notified by email when approved, please wait 48 hours before contacting our team regarding your registration.</p>
		<a href="/"><button class="btn btn-success">Return Home</button></a>
	</div>
	</div>
</div>